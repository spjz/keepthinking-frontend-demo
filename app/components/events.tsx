    ...
    return (
      <Section id="events" title="Events" titleBar={true}>
         <div className="grid grid-cols-3 gap-4">
            <div className="py-2">
              <div className="w-full size-64 bg-no-repeat bg-cover bg-center bg-[url('https://source.unsplash.com/random?distanz')]"></div>
            ...
            <div className="py-2">
              <div className="w-full size-64 bg-no-repeat bg-cover bg-center bg-[url('https://source.unsplash.com/random?sfmoma')]"></div>
            ...
            <div className="py-2">
              <div className="w-full size-64 bg-no-repeat bg-cover bg-center bg-[url('https://source.unsplash.com/random?cube')]"></div>
