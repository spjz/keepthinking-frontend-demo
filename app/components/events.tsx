    ...
    return (
      <Section id="events" title="Events" titleBar={true} link="/news">
         <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="py-2">
            <div className="w-full size-64 bg-no-repeat bg-cover bg-center bg-[url('/public/images/news-2.png')]"></div>
            ...
            <div className="py-2">
            <div className="w-full size-64 bg-no-repeat bg-cover bg-center bg-[url('/public/images/news-3.png')]"></div>
